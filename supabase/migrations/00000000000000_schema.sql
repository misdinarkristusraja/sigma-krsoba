-- ================================================================
-- SIGMA â€” Sistem Informasi Penjadwalan & Manajemen Misdinar
-- Paroki Kristus Raja Solo Baru
--
-- CONSOLIDATED MIGRATION â€” replaces 001..023
--
...
-- ----------------------------------------------------------------
-- get_current_user_role â€” bypass RLS recursion
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- get_my_profile â€” return full profile as jsonb
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- get_email_by_nickname â€” untuk login pakai username
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- is_rereg_open â€” apakah window daftar ulang terbuka
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- hitung_poin_kondisi â€” formula 6 kondisi
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- update_rekap_poin â€” cron daily
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- recalculate_streaks â€” hitung streak K1/K2/K3 mingguan
...
-- ----------------------------------------------------------------
-- process_misa_besar_scan â€” update attendance dari scan
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- generate_random_password â€” internal helper
-- ----------------------------------------------------------------
...
-- ----------------------------------------------------------------
-- change_my_password â€” user ganti password sendiri
-- ----------------------------------------------------------------
...
-- â”€â”€ scan_records (PERSEMPIT â€” hapus hole "scan: service write") â”€
...
-- â”€â”€ swap_requests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ rekap â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ system_config (semua login bisa baca, admin tulis) â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ misa_harian_availability â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ registrations (publik bisa insert, staff baca) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ reregistrations â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ streaks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
CREATE POLICY streak_read_self ON streaks FOR SELECT
  USING (auth.uid() = user_id
         OR get_current_user_role() IN ('Administrator','Pengurus','Pelatih'));

-- â”€â”€ event_latihan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ audit_logs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
