-- Migration 020: Document uploads
-- Adds sertifikat_komuni_url to registrations + users
-- Adds pernyataan_declared flag to registrations
-- Updates admin_approve_registration to carry sertifikat_komuni_url

ALTER TABLE registrations
  ADD COLUMN IF NOT EXISTS sertifikat_komuni_url TEXT,
  ADD COLUMN IF NOT EXISTS pernyataan_declared   BOOLEAN NOT NULL DEFAULT FALSE;

ALTER TABLE users
  ADD COLUMN IF NOT EXISTS sertifikat_komuni_url TEXT;

-- Recreate admin_approve_registration with sertifikat_komuni_url propagation
...
BEGIN
  ...
  INSERT INTO public.users (
    ...
    surat_pernyataan_url, sertifikat_komuni_url,
    ...
    v_reg.surat_pernyataan_url, v_reg.sertifikat_komuni_url,
...
GRANT EXECUTE ON FUNCTION admin_approve_registration(UUID, VARCHAR, TEXT) TO authenticated;
