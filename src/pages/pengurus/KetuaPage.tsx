  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h2 className="font-bold text-gray-900 text-base">Executive Dashboard Ketua &amp; Coordination</h2>
          <p className="text-xs text-gray-500">Ringkasan status seluruh divisi dan operasional kepengurusan Misdinar.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Link to="/pengurus/bendahara" className="card p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between text-emerald-600 mb-2">
            <span className="text-xs font-semibold text-gray-500">Saldo Kas</span>
            <Wallet size={18} />
          </div>
          <p className="text-lg font-bold text-emerald-700">Rp {stats.totalKas.toLocaleString('id-ID')}</p>
        </Link>

        <Link to="/pengurus/sekretaris" className="card p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between text-purple-600 mb-2">
            <span className="text-xs font-semibold text-gray-500">Notula &amp; Surat</span>
            <FileText size={18} />
          </div>
          <p className="text-2xl font-bold text-gray-900">{stats.totalNotula + stats.totalSurat}</p>
        </Link>

        <Link to="/pengurus/multimedia" className="card p-4 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between text-rose-600 mb-2">
            <span className="text-xs font-semibold text-gray-500">Jadwal Konten</span>
            <Video size={18} />
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="card p-5 space-y-3">
          <h3 className="font-bold text-gray-900 text-sm flex items-center gap-2">
            <ShieldCheck size={18} className="text-red-700" /> Pengawasan &amp; Tata Kelola Divisi
          </h3>
        ...
        <div className="card p-5 space-y-3">
          <h3 className="font-bold text-gray-900 text-sm flex items-center gap-2">
            <Shirt size={18} className="text-purple-700" /> Kesiapan Alat &amp; Misa Pekan Ini
          </h3>
          <p className="text-xs text-gray-600 leading-relaxed">
            Audit kesiapan peralatan liturgi oleh Putsankris mencatat total <strong>{stats.totalChecklists} kali audit Misa</strong> yang telah terverifikasi.
          </p>
        </div>
      </div>
    </div>
